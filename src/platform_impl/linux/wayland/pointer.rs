...
use smithay_client_toolkit::reexports::client::{protocol::wl_surface::WlSurface, Attached};

pub fn implement_pointer(
    seat: &Attached<wl_seat::WlSeat>,
    // FIXME move store to dispatchdata & maybe others too
    sink: EventsSink,
    ...
    // FIXME move store to dispatchdata?
    ...
    pointer.quick_assign(move |pointer, evt, _data| {
        ...
        match evt {
            PtrEvent::Enter {
                ...
                if let Some(wid) = wid {
                    ...
                    let position =
                        LogicalPosition::new(surface_x, surface_y).to_physical(scale_factor);
...
pub fn implement_relative_pointer(
    ...
    relative_pointer.quick_assign(move |_rel_pointer, evt, _data| match evt {
